...
/**
 * Side length of a labyrinth cell in mm
 */
#define LABYRINTH_CELLSIZE (253.3f)
 ...
 *          walls for all cells
 */
static inline const LabyrinthWalls_t* __attribute__((always_inline)) labyrinth_getAllWalls(void) {
	extern LabyrinthWalls_t labyrinthWalls;
