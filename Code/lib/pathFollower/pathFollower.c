...
PathFollowerStatus_t pathFollower_status = { false, { 0, 0 }, { 0, 0 }, { 0.0f, 0.0f } };
...
float pathFollower_lookaheadDistance = 1.0f;
...
uint8_t pathFollower_segmentLimit = 5;
...
//void (*pathFollower_callback)(const PathFollowerCommand_t, const uint8_t);
